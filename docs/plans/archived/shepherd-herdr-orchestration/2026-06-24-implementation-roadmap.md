...
- Non-deferred MVP phases 0 through 6 are complete.
- The Deferred section is intentionally outside the MVP implementation boundary.
- Current verification commands are `pnpm check` and `pnpm build`.
